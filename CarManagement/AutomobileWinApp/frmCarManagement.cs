...
namespace AutomobileWinApp
{
    public partial class frmCarManagement : Form
    {
        ...
        {
            var nameMember = txtSearch.Text;
            var memberList = carRepository.FilterName(nameMember);
            dgvCarList.DataSource = null;
            dgvCarList.DataSource = memberList;
        }

        private void cbSearch_SelectedIndexChanged(object sender, EventArgs e)
        {
            var cmbCountry = cbSearch.SelectedItem;
            var list = carRepository.FilterManufacture(cmbCountry.ToString());
            dgvCarList.DataSource = null;
            dgvCarList.DataSource = list;
        }
    }
}
