...
namespace AutomobileLibrary.Repository
{
    public class CarRepository : ICarRepository
    {
        ...
        public IEnumerable<Car> FilterName(string name) => CarDBContext.Instance.FilterName(name);
        public IEnumerable<Car> FilterManufacture(string manu) => CarDBContext.Instance.FilterManufacture(manu);
    }
}
